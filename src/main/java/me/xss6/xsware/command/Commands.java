package me.xss6.xsware.command;

import me.xss6.xsware.command.commands.BurrowBlockCommand;
...
public class Commands implements Globals {
    ...
    public Commands() {
        ...
        try {
            ArrayList<Class<?>> modClasses = ReflectionUtil.getClassesForPackage("me.xss6.xsware.command.commands");
    ...
    public void executeCommand(String command) {
        ...
        for(Command c : commands){
            try {
                ...
                ClientMessage.sendErrorMessage("messed it up while doing command");
                e.printStackTrace();
                return;
            }
        }
